...
/*
|--------------------------------------------------------------------------
| Authentication Routes - SiKerja V2
|--------------------------------------------------------------------------
*/

// SSO Routes (matching package paths)
Route::prefix('oauth/sso')->group(function () {
    Route::get('authorize', [SSOController::class, 'login'])->name('sso.authorize');
