    ...
    <AuthenticatedLayout>
        ...
        <section class="py-12">
            <div class="mx-auto max-w-full px-6 lg:px-8">
                <Breadcrumb class="mb-6" :crumbs="[
                    { label: 'Dashboard', route: 'dashboard' },
                    { label: share.title, route: null }
                ]" />

                <div class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">
                    <!-- Search and Filters -->
                    <div class="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                        <div class="flex flex-col sm:flex-row gap-2 md:gap-4">
                            <InputText size="small" v-model="search" placeholder="Cari jadwal / permohonan..." class="block w-full rounded-lg border border-gray-300 py-2.5 text-sm sm:w-80 dark:border-gray-600 dark:bg-gray-700 dark:text-white" />
                        </div>
                ...
                <div class="max-w-full w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6 dark:text-gray-100">
                    <!-- Data Table -->
                    <DataTable 
                        :value="datas?.data || []" 
                        dataKey="id"
                    ...
                    >
                        ...
                        <Column header="Jadwal Usulan" sortable>
                            <template #body="{ data }">
                                ...
                                <div class="mt-1 text-xs px-2 py-0.5 rounded inline-block"
                                    :class="{
                                        'bg-indigo-50 text-indigo-700': data.tipe === 'desk_to_desk',
                                        'bg-amber-50 text-amber-700': data.tipe === 'seremonial',
                                        'bg-purple-50 text-purple-700': data.tipe === 'hybrid',
                                    }">
                                    {{ data.tipe === 'desk_to_desk' ? 'Desk to Desk' : (data.tipe === 'seremonial' ? 'Seremonial' : 'Hybrid') }}
                                </div>
                            </template>
                        </Column>
